...
//        setNameLabel()
//        setUserFirstName()
//        UIViewController().setBackgroundImageView(self.view, imagePath: "main_background2")
//        setObservers()
//        setPhotoLabel()
//    }
//    
...
//        }
//        else if (UIViewController().iPhoneScreenSize() == "4.7") {
//            photoLabel.center.y = frameHeight * 0.38
//        }
//        else if (UIViewController().iPhoneScreenSize() == "5.5") {
...
//            }, completion: nil)//{(finished: Bool) in
